...
void ggml_compute_forward_tp_top1_stats(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_tp_top1_select(const struct ggml_compute_params * params, struct ggml_tensor * dst);
