...
extern "C" {
    ...
    enum ggml_tensor_flag {
        ...
        // Opt-in hint for the Meta backend to keep a LoRA delta lane-local until
        // it can be folded into the parent projection's existing AllReduce.
        GGML_TENSOR_FLAG_LORA_AR_FUSE = 32,
    };
